    ...
    if (loading) {
      ...
      <div className="results-card">
        <div className="card-header">
          ...
          <p className="match-quality">Matching your profile with this job…</p>
        </div>
      </div>
    );
    }
    ...
    <div className="results-card">
      ...
      <div className="content-section">
        <div className="section-header">
          <svg className="section-icon" fill="none" stroke="#dc2626" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
        ...
        <div className="deal-breakers-list">
            {safeResult.unmet_or_unknown_deal_breakers.map((item, idx) => (
      ...
      <div className="content-section">
        <div className="section-header">
          <svg className="section-icon" fill="none" stroke="#10b981" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth="2"
        ...
        <div className="skills-grid">
          {safeResult.matched_skills.length === 0 && (
            <div className="skill-chip skill-matched">No matched skills detected</div>
          )}
      ...
      <div className="content-section">
        <div className="section-header">
          <svg className="section-icon" fill="none" stroke="#f59e0b" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth="2"
        ...
        <div className="skills-grid">
          {safeResult.important_skills_missing.length === 0 && (
            <div className="skill-chip skill-missing">No important skills missing</div>
          )}
      ...
      <div className="content-section">
        <div className="section-header">
          <svg className="section-icon" fill="none" stroke="#6366f1" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth="2"
        ...
        <div className="skills-grid">
          {safeResult.things_to_work_on.length === 0 && (
            <div className="skill-chip skill-work-on">No specific suggestions</div>
          )}
      ...
      <div className="recommendation-box">
        ...
        <div className="recommendation-text">
          <strong>Recommendation:</strong> <span>{recommendationText}</span>
        </div>
      </div>
    </div>
  );
